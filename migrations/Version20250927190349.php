...
final class Version20250927190349 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE "action" (id VARCHAR(36) NOT NULL, project_id VARCHAR(36) NOT NULL, type_id VARCHAR(36) NOT NULL, status_id VARCHAR(36) NOT NULL, titolo VARCHAR(255) NOT NULL, descrizione VARCHAR(255) DEFAULT NULL, stima_min INTEGER NOT NULL, deadline DATE DEFAULT NULL --(DC2Type:date_immutable)
        ...
        $this->addSql('CREATE TABLE action_status (id VARCHAR(36) NOT NULL, descrizione VARCHAR(255) NOT NULL, ordine INTEGER NOT NULL, chiusura BOOLEAN NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE action_type (id VARCHAR(36) NOT NULL, descrizione VARCHAR(255) NOT NULL, colore VARCHAR(255) DEFAULT NULL, icona VARCHAR(255) DEFAULT NULL, fatturabile_default BOOLEAN NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE client (id VARCHAR(36) NOT NULL, denominazione VARCHAR(255) NOT NULL, piva VARCHAR(255) DEFAULT NULL, cf VARCHAR(255) DEFAULT NULL, email VARCHAR(255) DEFAULT NULL, telefono VARCHAR(255) DEFAULT NULL, via VARCHAR(255) DEFAULT NULL, cap VARCHAR(255) DEFAULT NULL, citta VARCHAR(255) DEFAULT NULL, note VARCHAR(255) DEFAULT NULL, created_at DATETIME DEFAULT NULL --(DC2Type:datetime_immutable)
        , updated_at DATETIME DEFAULT NULL --(DC2Type:datetime_immutable)
        , PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE setting (id VARCHAR(36) NOT NULL, chiave VARCHAR(255) NOT NULL, valore VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE time_entry (id VARCHAR(36) NOT NULL, project_id VARCHAR(36) NOT NULL, project_action_id VARCHAR(36) NOT NULL, start_at DATETIME NOT NULL --(DC2Type:datetime_immutable)
        ...
        $this->addSql('CREATE TABLE user (id VARCHAR(36) NOT NULL, cliente_id VARCHAR(36) DEFAULT NULL, email VARCHAR(180) NOT NULL, roles CLOB NOT NULL --(DC2Type:json)
